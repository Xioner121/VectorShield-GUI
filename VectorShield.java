...
//Imports WriteSettings as a constructor
   ...
   boolean[] Networking = new boolean[14];
   boolean[] LocalSecPol = new boolean[23];
   boolean[] Lusrmgr = new boolean[29];
   boolean[] Services = new boolean[37];
   boolean[] CyPat = new boolean[4];
...
//Beginning of script
   ...
   // Beginning of GUI building code:
      ...
      hardenSyst.setGraphic(new ImageView(new Image(new File("buttonIcon.png").toURI().toString(), 37, 42, true, true)));
      ...
      highDesc.getStyleClass().add("labels");
                     ...
                     //Images Homepage
      ImageView imagelow = new ImageView(new Image(getClass().getResourceAsStream("/low.png")));
       imagelow.setFitHeight(150); 
       imagelow.setFitWidth(150); 
       imagelow.setPreserveRatio(true);
      ImageView imageMid = new ImageView(new Image(getClass().getResourceAsStream("/mid.png")));
       imageMid.setFitHeight(150); 
       imageMid.setFitWidth(150); 
       imageMid.setPreserveRatio(true);
      ImageView imageHigh = new ImageView(new Image(getClass().getResourceAsStream("/high.png")));
       imageHigh.setFitHeight(150); 
       imageHigh.setFitWidth(150); 
       imageHigh.setPreserveRatio(true);
      ImageView vectorShieldLogo = new ImageView(new Image(getClass().getResourceAsStream("/VectorShield.png")));
      ...
      SecretSettings.setToggleGroup(SettingsButtons);
                           //Images for settings  
      ImageView settingsLogo = new ImageView(new Image(getClass().getResourceAsStream("/gear.png")));
       settingsLogo.setX(0); 
       settingsLogo.setY(0); 
       ...
       settingsLogo.setPreserveRatio(true); 
        ...
        CheckBox Netroot = new CheckBox("Networking");//Check boxes can be set on action the same way a button is.
          CheckBox NetSecurity = new CheckBox("Network Security");
            ...
            CheckBox N13 = new CheckBox("Enable Windows Smartscreen");
            CheckBox[] NetSecurityBoxes = {N0, N1, N2, N3, N4, N6, N7, N8, N13};
         ...
         CheckBox[] NetworkBoxes1 = {NetSecurity, N0, N1, N2, N3, N4, N5, N6, N7, N8, NetProtocol, N9, N10, N11, N12, N13};
        ...
        CheckBox ServiceRoot = new CheckBox("Services");
          ...
          CheckBox ServiceGeneric = new CheckBox("Miscellaneous services");
            ...
            CheckBox[] ServiceGenericBoxes = {R7, R10, R13, R23, R32, R34};
               CheckBox[] ServiceBoxes1 = {ServiceNetwork, ServiceShare, ServiceAccess, ServiceNetpro, ServiceWindows, ServiceGeneric, R0, R1, R2, R3, R4, R5, R6, R21, R22, R14, R15, R16, R17, R18, R8, R9, R11, R12, R19, R20, R24, R25, R26, R27, R28, R29, R30, R31, R33, R7, R10, R13, R23, R32, R34, R35, R36};
      ...
      TreeItem<CheckBox> ServicesGeneric = new TreeItem<>(ServiceGeneric);
       ...
       if (ServiceGeneric.isSelected()) {
        ...
        CheckBox cyPat2 = new CheckBox("Rename Admin account to name 'VS1'");
        CheckBox cyPat3 = new CheckBox("Rename guest account to name 'VS2'");

      ListView<CheckBox> secretOptions = new ListView<>();
      secretOptions.getItems().addAll(cyPat0, cyPat1, cyPat2, cyPat3);
      ...
      Label ProgressBarDescription = new Label("Securing System. Please wait...");
         ImageView vectorShieldLogo2 = new ImageView(new Image(getClass().getResourceAsStream("/VectorShield.png")));
       vectorShieldLogo2.setFitHeight(400); 
       vectorShieldLogo2.setFitWidth(500); 
       vectorShieldLogo2.setPreserveRatio(true);    
         ImageView loadingCircle = new ImageView(new Image(getClass().getResourceAsStream("/loading.png")));
      ...
      rotateTransition.setInterpolator(Interpolator.LINEAR);
                                        ...
                                        ImageView loadingCheck = new ImageView(new Image(getClass().getResourceAsStream("/loading1.png")));
      ...
      hardenSyst.setOnAction(
         e -> {
            ...
            if (harden == true) {//IMPORTANT: Handles checkboxes, modifying the array based on their state.
             CheckBox[] NetworkBoxes = {N0, N1, N2, N3, N4, N5, N6, N7, N8, N9, N10, N11, N12, N13};
             ...
             CheckBox[] ServiceBoxes = {R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29, R30, R31, R32, R33, R34, R35, R36};
             CheckBox[] CyPatBoxes = {cyPat0, cyPat1, cyPat2, cyPat3};
      ...
      rotateTransition.play();
                          ...
                          try {
    final Process p1 = runtime.exec("cmd /c start /min /wait core.bat");    
    Thread t=new Thread(()->{
        try{
            p1.waitFor();
...
CheckBox[] AllBoxes = {Netroot, NetSecurity, NetProtocol, SecpolRoot, SecpolSecurity, SecpolMedia, SecpolClient, SecpolUser, LusrmgrRoot, LusrmgrAccount, LusrmgrAccess, LusrmgrAction, LusrmgrLogon, LusrmgrMaintenance, LusrmgrBasic, ServiceRoot, ServiceNetwork, ServiceShare, ServiceAccess, ServiceNetpro, ServiceWindows, ServiceGeneric, N0, N1, N2, N3, N4, N5, N6, N7, N8, N9, N10, N11, N12, N13, S0, S1, S2, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13, S14, S15, S16, S17, S18, S19, S20, S21, S22, L0, L1, L2, L3, L4, L5, L6, L7, L8, L9, L10, L11, L12, L13, L14, L15, L16, L17, L18, L19, L20, L21, L22, L23, L24, L25, L26, L27, L28, R0, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16, R17, R18, R19, R20, R21, R22, R23, R24, R25, R26, R27, R28, R29, R30, R31, R32, R33, R34, R35, R36, cyPat0, cyPat1, cyPat2, cyPat3};
               //Low medium and high buttons
                   low.setOnAction(e -> {
            CheckBox[] LowBoxes = {NetSecurity, LusrmgrLogon, LusrmgrAccount, N0, N1, N2, N3, N4, N5, N6, N7, N8, N9, N10, N11, N13, S0, S1, S3, S4, S5, S6, S10, S11, S12, S13, S17, S18, S21, L0, L1, L3, L4, L11, L12, L15, L17, L20, R5, R6, R8, R15, R17, R22, R23, R33, R35};
            CheckBox[] NoBoxes = {};
       if (low.isSelected()) {
         changeBoxes(LowBoxes, AllBoxes);
            ...
            CheckBox[] MidBoxes = {Netroot, NetSecurity, NetProtocol, SecpolMedia, LusrmgrAccount, LusrmgrAccess, LusrmgrAction, LusrmgrLogon, LusrmgrMaintenance, ServiceAccess, N0, N1, N2, N3, N4, N5, N6, N7, N8, N9, N10, N11, N12, N13, S0, S1, S3, S4, S5, S6, S7, S8, S9, S10, S11, S12, S13, S14, S17, S18, S19, S20, S21, L0, L1, L2, L3, L4, L5, L6, L7, L8, L9, L10, L11, L12, L14, L15, L16, L17, L18, L19, L20, L21, L22, L23, L24, L25, R1, R2, R3, R4, R5, R6, R7, R8, R11, R12, R13, R14, R15, R16, R17, R18, R20, R21, R22, R23, R24, R28, R33, R35, R36};
            CheckBox[] NoBoxes = {};
